...
from services.schemas.insight_schemas import FieldScheme, GetObjectData, InsightObject, UpdateObjectData
...
async def test_update_object(client: MarsClient):
    ...
    data = UpdateObjectData(
        scheme=10, object_type_id=155, object_id=563705, attrs={1892: [reverse_state[obj.get_field_values("State")[0].label]]}
    )
